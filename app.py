...
SKILLS: dict[str, list[str]] = {
    ...
    "Statistical Methods": [
        ...
        "Elo rating system",
        "Leakage-aware rolling windows",
        "AUC calibration diagnostics",
    ],
    "Deep Learning": [
        "Feedforward networks (ANN)",
        "CNN",
        "RNN",
...
NBA_PLOTS: list[dict[str, str]] = [
    {
        "file": "nba_plots/shot_density_hexbin_dark.png",
        "title": "League Shot Density (Dark Hexbin)",
        "caption": "League-wide hexbin shot density map highlighting concentration patterns across court zones.",
    },
    {
...
AI_COURSES: list[dict[str, str]] = [
    {"prefix": "BAN", "number": "518", "title": "E-commerce Analytics And Strategy"},
    {
        "prefix": "CIT",
        "number": "460",
        "title": "Emerging Technologies In Information Technology",
    },
    ...
    {"prefix": "EE", "number": "543", "title": "Pattern Recognition"},
    {
        "prefix": "ETC",
        "number": "767",
        "title": "Research In Learning Analytics And Artificial Intelligence",
    },
    ...
    {"prefix": "INF", "number": "586", "title": "Data Analytics Capstone"},
    {
        "prefix": "MRE",
        "number": "372",
        "title": "Introduction To Probability And Machine Learning",
    },
    ...
    {"prefix": "PSY", "number": "305", "title": "Data Science And AI In Psychology"},
    {
        "prefix": "PSY",
        "number": "305H",
        "title": "Data Science And AI In Psychology - Honors",
    },
    {
        "prefix": "PSY",
        "number": "628",
        "title": "Research Dissemination Skills In The Psychological Sciences",
    },
]
...
KEY_METRICS: list[dict[str, str]] = [
    ...
    {
        "label": "Course Prefixes Crawled",
        "value": "150+",
        "source": "nau_course_scraping",
    },
